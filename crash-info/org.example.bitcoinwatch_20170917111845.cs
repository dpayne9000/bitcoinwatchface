...
r0   = 0x00000000, r1   = 0x407247f3
r2   = 0x00000000, r3   = 0x00000001
r4   = 0xf72c79b8, r5   = 0xf72c79b8
r6   = 0xf72c716c, r7   = 0xf72c79b8
r8   = 0xf72c79b8, r9   = 0xf7dccff8
r10  = 0xf72d5b10, fp   = 0x0000018f
ip   = 0x00000001, sp   = 0xff9f49c0
lr   = 0xf72b71f9, pc   = 0x00000000
cpsr = 0x60000030
...
Maps Information
f2f2c000 f372b000 rw-p [stack:5511]
f37c8000 f37df000 r-xp /usr/lib/edje/modules/elm/linux-gnueabi-armv7l-1.0.0/module.so
f37ec000 f37f7000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
f3800000 f380b000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
f3814000 f4013000 rw-p [stack:5504]
f4213000 f4223000 r-xp /usr/lib/libmdm-common.so.1.1.24
f422b000 f4236000 r-xp /usr/lib/libtbm.so.1.0.0
f423e000 f4287000 r-xp /usr/lib/libmdm.so.1.2.69
f428f000 f4295000 r-xp /usr/lib/libcsc-feature.so.0.0.0
f429d000 f429f000 r-xp /usr/lib/libdri2.so.0.0.0
f42a7000 f42af000 r-xp /usr/lib/libdrm.so.2.4.0
f42b7000 f42c7000 r-xp /usr/lib/libwidget_provider.so.1.0.0
f42cf000 f42d8000 r-xp /usr/lib/libcom-core.so.0.0.1
f5b7a000 f5b7f000 r-xp /usr/lib/libcapi-system-info.so.0.2.0
f5b87000 f5ba0000 r-xp /usr/lib/libnetwork.so.0.0.0
f5ba8000 f5bb2000 r-xp /usr/lib/libwidget.so.1.0.0
f5bba000 f5bcd000 r-xp /usr/lib/libwidget_service.so.1.0.0
f5bd6000 f5bdd000 r-xp /usr/lib/libwidget_provider_app.so.1.0.0
f5be6000 f5cec000 r-xp /usr/lib/libicuuc.so.57.1
f5d02000 f5e8a000 r-xp /usr/lib/libicui18n.so.57.1
f5e9a000 f5ea7000 r-xp /usr/lib/libalarm.so.0.0.0
f5eb1000 f5ec0000 r-xp /usr/lib/libjson-glib-1.0.so.0.1001.3
f5ec9000 f5ed9000 r-xp /usr/lib/libcapi-network-connection.so.1.0.64
f5ee1000 f5ee9000 r-xp /usr/lib/libappcore-watch.so.1.1
f5efb000 f5f00000 r-xp /usr/lib/bufmgr/libtbm_exynos.so.0.0.0
f609a000 f60a4000 r-xp /lib/libnss_files-2.13.so
f60ad000 f617c000 r-xp /usr/lib/libscim-1.0.so.8.2.3
f6192000 f61b6000 r-xp /usr/lib/ecore/immodules/libisf-imf-module.so
f61bf000 f61c5000 r-xp /usr/lib/libappsvc.so.0.1.0
f61cd000 f61d1000 r-xp /usr/lib/libcapi-appfw-app-control.so.0.3.2.5
f61df000 f61e1000 r-xp /opt/usr/apps/org.example.bitcoinwatch/bin/bitcoinwatch
f61f1000 f61f3000 r-xp /usr/lib/libiniparser.so.0
f61fc000 f6201000 r-xp /usr/lib/libappcore-common.so.1.1
f6209000 f620b000 r-xp /usr/lib/libcapi-appfw-app-common.so.0.3.2.5
f6214000 f6218000 r-xp /usr/lib/libcapi-appfw-application.so.0.3.2.5
f6225000 f6227000 r-xp /usr/lib/libXau.so.6.0.0
f622f000 f6236000 r-xp /lib/libcrypt-2.13.so
f6266000 f6268000 r-xp /usr/lib/libiri.so
f6271000 f641a000 r-xp /usr/lib/libcrypto.so.1.0.0
f643a000 f6481000 r-xp /usr/lib/libssl.so.1.0.0
f648d000 f64bb000 r-xp /usr/lib/libidn.so.11.5.44
f64c3000 f64cc000 r-xp /usr/lib/libcares.so.2.1.0
f64d6000 f64e9000 r-xp /usr/lib/libxcb.so.1.1.0
f64f2000 f64f4000 r-xp /usr/lib/journal/libjournal.so.0.1.0
f64fc000 f64fe000 r-xp /usr/lib/libSLP-db-util.so.0.1.0
f6507000 f65d3000 r-xp /usr/lib/libxml2.so.2.7.8
f65e0000 f65e2000 r-xp /usr/lib/libgmodule-2.0.so.0.3200.3
f65eb000 f65f0000 r-xp /usr/lib/libffi.so.5.0.10
f65f8000 f65f9000 r-xp /usr/lib/libgthread-2.0.so.0.3200.3
f6601000 f6604000 r-xp /lib/libattr.so.1.1.0
f660c000 f66a0000 r-xp /usr/lib/libstdc++.so.6.0.16
f66b3000 f66d0000 r-xp /usr/lib/libsecurity-server-commons.so.1.0.0
f66da000 f66f2000 r-xp /usr/lib/libpng12.so.0.50.0
f66fa000 f6710000 r-xp /lib/libexpat.so.1.6.0
f671a000 f675e000 r-xp /usr/lib/libcurl.so.4.3.0
f6767000 f6771000 r-xp /usr/lib/libXext.so.6.4.0
f677a000 f677e000 r-xp /usr/lib/libXtst.so.6.1.0
f6786000 f678c000 r-xp /usr/lib/libXrender.so.1.3.0
f6794000 f679a000 r-xp /usr/lib/libXrandr.so.2.2.0
f67a2000 f67a3000 r-xp /usr/lib/libXinerama.so.1.0.0
f67ac000 f67b5000 r-xp /usr/lib/libXi.so.6.1.0
f67bd000 f67c0000 r-xp /usr/lib/libXfixes.so.3.1.0
f67c8000 f67ca000 r-xp /usr/lib/libXgesture.so.7.0.0
f67d2000 f67d4000 r-xp /usr/lib/libXcomposite.so.1.0.0
f67dc000 f67de000 r-xp /usr/lib/libXdamage.so.1.1.0
f67e6000 f67ed000 r-xp /usr/lib/libXcursor.so.1.0.2
f67f5000 f67f8000 r-xp /usr/lib/libecore_input_evas.so.1.7.99
f6800000 f6804000 r-xp /usr/lib/libecore_ipc.so.1.7.99
f680d000 f6812000 r-xp /usr/lib/libecore_fb.so.1.7.99
f681b000 f68fc000 r-xp /usr/lib/libX11.so.6.3.0
f6907000 f692a000 r-xp /usr/lib/libjpeg.so.8.0.2
f6942000 f6958000 r-xp /lib/libz.so.1.2.5
f6960000 f6962000 r-xp /usr/lib/libsecurity-extension-common.so.1.0.1
f696a000 f69df000 r-xp /usr/lib/libsqlite3.so.0.8.6
f69e9000 f6a03000 r-xp /usr/lib/libpkgmgr_parser.so.0.1.0
f6a0b000 f6a3f000 r-xp /usr/lib/libgobject-2.0.so.0.3200.3
f6a48000 f6b1b000 r-xp /usr/lib/libgio-2.0.so.0.3200.3
f6b26000 f6b36000 r-xp /lib/libresolv-2.13.so
f6b3a000 f6b52000 r-xp /usr/lib/liblzma.so.5.0.3
f6b5a000 f6b5d000 r-xp /lib/libcap.so.2.21
f6b65000 f6b94000 r-xp /usr/lib/libsecurity-server-client.so.1.0.1
f6b9d000 f6b9e000 r-xp /usr/lib/libecore_imf_evas.so.1.7.99
f6ba6000 f6bac000 r-xp /usr/lib/libecore_imf.so.1.7.99
f6bb4000 f6bcb000 r-xp /usr/lib/liblua-5.1.so
f6bd4000 f6bdb000 r-xp /usr/lib/libembryo.so.1.7.99
f6be3000 f6be9000 r-xp /lib/librt-2.13.so
f6bf2000 f6c48000 r-xp /usr/lib/libpixman-1.so.0.28.2
f6c55000 f6cab000 r-xp /usr/lib/libfreetype.so.6.11.3
f6cb7000 f6cdf000 r-xp /usr/lib/libfontconfig.so.1.8.0
f6ce0000 f6d25000 r-xp /usr/lib/libharfbuzz.so.0.10200.4
f6d2e000 f6d41000 r-xp /usr/lib/libfribidi.so.0.3.1
f6d49000 f6d63000 r-xp /usr/lib/libecore_con.so.1.7.99
f6d6c000 f6d75000 r-xp /usr/lib/libedbus.so.1.7.99
f6d7d000 f6dcd000 r-xp /usr/lib/libecore_x.so.1.7.99
f6dcf000 f6dd8000 r-xp /usr/lib/libvconf.so.0.2.45
f6de0000 f6df1000 r-xp /usr/lib/libecore_input.so.1.7.99
f6df9000 f6dfe000 r-xp /usr/lib/libecore_file.so.1.7.99
f6e06000 f6e28000 r-xp /usr/lib/libecore_evas.so.1.7.99
f6e31000 f6e72000 r-xp /usr/lib/libeina.so.1.7.99
f6e7b000 f6e94000 r-xp /usr/lib/libeet.so.1.7.99
f6ea5000 f6f0e000 r-xp /lib/libm-2.13.so
f6f17000 f6f1d000 r-xp /usr/lib/libcapi-base-common.so.0.1.8
f6f26000 f6f27000 r-xp /usr/lib/libsecurity-extension-interface.so.1.0.1
f6f2f000 f6f52000 r-xp /usr/lib/libpkgmgr-info.so.0.0.17
f6f5a000 f6f5f000 r-xp /usr/lib/libxdgmime.so.1.1.0
f6f67000 f6f91000 r-xp /usr/lib/libdbus-1.so.3.8.12
f6f9a000 f6fb1000 r-xp /usr/lib/libdbus-glib-1.so.2.2.2
f6fb9000 f6fc4000 r-xp /lib/libunwind.so.8.0.1
f6ff1000 f700f000 r-xp /usr/lib/libsystemd.so.0.4.0
f7019000 f713d000 r-xp /lib/libc-2.13.so
f714b000 f7153000 r-xp /lib/libgcc_s-4.6.so.1
f7154000 f7158000 r-xp /usr/lib/libsmack.so.1.0.0
f7161000 f7167000 r-xp /usr/lib/libprivilege-control.so.0.0.2
f716f000 f723f000 r-xp /usr/lib/libglib-2.0.so.0.3200.3
f7240000 f729e000 r-xp /usr/lib/libedje.so.1.7.99
f72a8000 f72bf000 r-xp /usr/lib/libecore.so.1.7.99
f72d6000 f73a4000 r-xp /usr/lib/libevas.so.1.7.99
f73c9000 f7505000 r-xp /usr/lib/libelementary.so.1.7.99
f751c000 f7530000 r-xp /lib/libpthread-2.13.so
f753b000 f753d000 r-xp /usr/lib/libdlog.so.0.0.0
f7545000 f7548000 r-xp /usr/lib/libbundle.so.0.1.22
f7550000 f7552000 r-xp /lib/libdl-2.13.so
f755b000 f7568000 r-xp /usr/lib/libaul.so.0.1.0
f757a000 f7580000 r-xp /usr/lib/libappcore-efl.so.1.1
f7589000 f758d000 r-xp /usr/lib/libsys-assert.so
f7596000 f75b3000 r-xp /lib/ld-2.13.so
f75bc000 f75c1000 r-xp /usr/bin/launchpad-loader
f7d95000 f7f44000 rw-p [heap]
ff9d5000 ff9f6000 rw-p [stack]
End of Maps Information

Callstack Information (PID:5487)
Call Stack Count: 2
 0: (0xf72b71f9) [/usr/lib/libecore.so.1] + 0xf1f9
 1: ((nil)) (null)
End of Call Stack
...
09-17 11:28:48.951-0700 W/CRASH_MANAGER( 3220): worker.c: worker_job(1205) > 1105487626974150567232
